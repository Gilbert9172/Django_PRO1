...
> ***필히 개선 되어야할 부분이다. 현재 Django에 대한 이해도가 깊은 상태는 아니기 때문에***

> ***Django에 대한 공부(ex.RESTful API, Class기반 개발 등)를 지속적으로 하여 안전하고,***

> ***다양한 서비스를 할 수 있는 G-Store를 배포할 것이다.***
